...
function render(anim) {
	...
	renderRow(anim, 4, 1);
	renderRow(anim, 5, 0.75);
	renderRow(anim, 6, 0.5);
	renderRow(anim, 7, 0.25);
	renderRow(anim, 8, 1);
	renderRow(anim, 9, 0.75);
	renderRow(anim, 10, 0.5);
	renderRow(anim, 11, 0.25);
}
